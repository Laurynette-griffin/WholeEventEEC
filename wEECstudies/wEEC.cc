...
int main(int argc, char* argv[]) {
    ...
    TH1F EEC_wp("EEC_w_phi", "Energy Energy Correlator", bins, topi);
    TH1F EEC_tp("EEC_w_lowphi", "Energy Energy Correlator", bins, topi);
    TH1F EEC_mp("EEC_w_midphi", "Energy Energy Correlator", bins, topi);
    TH1F EEC_sp("EEC_w_hiphi", "Energy Energy Correlator", bins, topi);
       ...
       // pT cut > .2 GeV
        ...
        for (size_t i = 0; i < charged_event.size(); ++i) {
            for (size_t j = i + 1; j < charged_event.size(); ++j) {
                ...
                if ((ui == 1 || uj == 1) && (ui == 1 || uj == 1))  EEC_tp.Fill(delphi, eec/pmq2);
                
                if ((ui == -1 || uj == -1) && (ui == 1 || uj == 1)) EEC_mp.Fill(delphi, eec/pmq2);
                
                if ((ui == -1 || uj == -1) && (ui == -1 || uj == -1)) EEC_sp.Fill(delphi, eec/pmq2);
