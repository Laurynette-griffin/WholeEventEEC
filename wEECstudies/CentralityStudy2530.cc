       ...
       // pT cut > .2 GeV
        ...
        for (size_t i = 0; i < charged_event.size(); ++i) {
            for (size_t j = i + 1; j < charged_event.size(); ++j) {
                ...
                if (jets[1].pt() >= 9.4 && jets[1].pt() < 20.9) EEC_l.Fill(z, eec/pmq2);
                if (jets[1].pt() >= 20.9 && jets[1].pt() < 27.3) EEC_m.Fill(z, eec/pmq2);
                if (jets[1].pt() >= 27.3 && jets[1].pt() < 31.2) EEC_h.Fill(z, eec/pmq2);
                
                EEC_wp.Fill(delphi, eec/pmq2);
                
                if (jets[1].pt() >= 9.4 && jets[1].pt() < 20.9) EEC_lp.Fill(delphi, eec/pmq2);
                if (jets[1].pt() >= 20.9 && jets[1].pt() < 27.3) EEC_mp.Fill(delphi, eec/pmq2);
                if (jets[1].pt() >= 27.3 && jets[1].pt() < 31.2) EEC_hp.Fill(delphi, eec/pmq2);
