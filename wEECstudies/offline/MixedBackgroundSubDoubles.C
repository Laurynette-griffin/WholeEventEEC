...
using namespace std;
void MixedBackgroundSubDoubles() {
   ...
   /* const char* filename = {
    ...
    TFile* file = TFile::Open("../../outfiles/ztotheta_2025-10-14_1.root");
    int const number = 2;
    //17;
    double min = 1e4; // initializing min and max for y axis because its easier to do right axis later. Def a better way to do this
    double max = 1e8;
    ...
    //mixed event 
    vector<const char*> histonames = { "EEC_z", "EEC_theta"};
    ...
    //vector<const char*> histonames = {"EEC_wpl","EEC_spl",  "EEC_mpl","EEC_tpl","EEC_mspl", "EEC_mmpl", "EEC_m2pl"};
    ...
    TH1D* t12t23;
    TH1D* sm;
    string outputFilename = "../plots/zvsthetacheckersept30.C";
    string outputFilename1 = "../plots/zvsthetacheckersept30.png";
...
/*
 ...
 // pre bin width subtraction + bin width & integral normalization + log to linear shift (final histogram )  :)
	...
	mbssignalfinal->SetMarkerColor(kOrange);
	mbssignalfinal->SetLineColor(kOrange);
    ...
    */
    ...
    rh->SetTitle("");
    //rh->GetYaxis()->SetTitle("Pythia / MBS");
  ...
  /*
    ...
    */
    ...
    legend->AddEntry(EEC_w_p[3], "Thermal + Thermal", "pl");
    legend->AddEntry(EEC_w_p[4], "Mixed + Signal", "pl");
    legend->AddEntry(EEC_w_p[5], "Mixed + Mixed", "pl");
    legend->AddEntry(EEC_w_p[6], "Mixed1 + Mixed2", "pl");
