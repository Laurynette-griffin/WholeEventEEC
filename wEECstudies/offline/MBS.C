...
void MBS() {
   ...
   /* const char* filename = {
       ...
       */
    TFile* file = TFile::Open("../outfiles/pythia_mixedevent_03_15pthat50_May27_50m.root");
    ...
    string outputFilename = "../plots/tryJul30.C";
    string outputFilename1 = "../plots/tryJul30.png";
 ...
 // pre bin width subtraction + bin width & integral normalization + log to linear shift (final histogram )  :)
    ...
    TLegend* legend = new TLegend(0.55, 0.125, 0.875, 0.425);
