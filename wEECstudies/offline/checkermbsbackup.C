...
void checkermbs() {
   ...
   /* const char* filename = {
       ...
       */
    TFile* file = TFile::Open("../outfiles/triplechecker_mbs_xtrahists_100k_Sep11.root");
    //TFile* file = TFile::Open("../outfiles/oomtestmbs.root");
    cout <<"1" << endl;   
    ...
    vector<const char*> histonames = {"EEC_pt1", "EEC_pt2","EEC_pt3", "EEC_t1t1", "EEC_t2t2", "EEC_t3t3", "EEC_t1t2", "EEC_t2t3", "EEC_t1t3"};
    ...
    string outputFilename = "../plots/weecmathcheckSep11thermalsq.C";
    string outputFilename1 = "../plots/weecmathcheckSep11thermalsq.png";
 ...
 // pre bin width subtraction + bin width & integral normalization + log to linear shift (final histogram )  :)
    ...
    */
    ...
    pad2->cd();
    pt12 = (TH1D*)EEC_w_p[3]->Clone();
    p2 = (TH1D*)EEC_w_p[4]->Clone();
    ...
    pt13 = (TH1D*)EEC_w_p[3]->Clone();
    p3 = (TH1D*)EEC_w_p[5]->Clone();
    pt13->Divide(p3);
